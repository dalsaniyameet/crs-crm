        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 32, alignItems: "start" }}>
          ...
          <div>
            ...
            <div style={{ padding: "20px", borderRadius: 16, background: "rgba(234,179,8,0.04)", border: "1px solid rgba(234,179,8,0.15)" }}>
              ...
              <a href="tel:+919825031247" style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 14, color: "#eab308", textDecoration: "none", marginBottom: 8 }}>
                <Phone className="w-4 h-4" /> +91 98250 31247
              </a>
          ...
          <div style={{ padding: "32px 28px", borderRadius: 24, background: "rgba(255,255,255,0.02)", border: "1px solid rgba(234,179,8,0.12)" }}>
            {done ? (
              ...
              <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                {[
                  { key: "name",    label: "Your Name",    icon: User,      type: "text",  placeholder: "Your full name" },
                  { key: "company", label: "Company Name", icon: Building2, type: "text",  placeholder: "Your company name" },
                  { key: "phone",   label: "Phone Number", icon: Phone,     type: "tel",   placeholder: "Your mobile number" },
                  { key: "email",   label: "Email Address",icon: Mail,      type: "email", placeholder: "Your email address" },
                ].map(f => (
                  <div key={f.key}>
                ...
                <div>
                  ...
                  <div style={{ position: "relative" }}>
                    ...
                    <textarea
                      rows={3} placeholder="Your team size and requirements..."

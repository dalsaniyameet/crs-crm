...
export default function SplashScreen() {
  useEffect(() => {
    ...
    style.textContent = `
      ...
      #crs-splash-logo{width:min(200px,52vw);height:min(200px,52vw);border-radius:28px;object-fit:contain;background:#ffffff;padding:16px;position:relative;z-index:2;animation:crsLogoIn 0.9s cubic-bezier(0.175,0.885,0.32,1.275) forwards;box-shadow:0 0 0 3px rgba(234,179,8,0.5),0 0 60px rgba(234,179,8,0.25),0 20px 60px rgba(0,0,0,0.6);}

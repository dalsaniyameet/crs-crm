import {
  ...
  FileText, IndianRupee, MessageCircle, CalendarDays, ClipboardList,
} from "lucide-react";
...
const ALL_NAV = [
  ...
  { href: "/owners",          label: "Property Owners",   icon: UserSquare2,     roles: ["ADMIN","BROKER","SALES_MANAGER"] },
  ...
  { href: "/marketing",       label: "Marketing",         icon: Megaphone,       roles: ["ADMIN","MARKETING","SALES_MANAGER"] },
